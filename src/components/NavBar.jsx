  ...
  return (
    <>
      <nav className="flex lg:flex-col gap-2 px-4 py-2 items-center lg:gap-8 lg:py-12">
        ...
        <button onClick={logout} className="w-2/12 h-12 bg-blue-500 p-2 font-semibold rounded-lg hover:bg-blue-600 text-white dark:bg-gray-300 dark:text-black dark:hover:bg-blue-500 lg:w-full lg:h-10 lg:my-8 0xl:my-6 0xl:h-14">
          Cerrar Sesión
        </button>
