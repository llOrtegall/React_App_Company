      ...
      <form className='w-96 mb-2 border p-12 rounded-lg bg-white/30 flex flex-col gap-4 shadow-xl' onSubmit={(ev) => handleSubmit(ev)}>
        ...
        <article className='w-full flex flex-col gap-2'>
          ...
          <div className='flex items-center w-full justify-around gap-4'>
            <UserIcon size={10}/>
            <input name='username' type='text' placeholder='CV1118*****' required autoComplete='username' className='w-full p-2 rounded-md border-none outline-none'
        ...
        <article className='w-full flex flex-col gap-2 mb-4'>
          ...
          <div className='flex items-center w-full justify-around gap-4'>
            <LockIcon size={10}/>
            <input name='password' type='password' placeholder='**********' required autoComplete='username' className='w-full p-2 rounded-md border-none outline-none'
